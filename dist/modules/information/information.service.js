...
let InformationService = class InformationService {
    ...
    async create(body, user) {
        ...
        if (await this.informationRepository.findOne()) {
            throw new common_1.BadRequestException(app_messages_1.APP_MESSAGES.INFORMATION_EXIST);
        }
    ...
    async find() {
        ...
        if (!information) {
            throw new common_1.NotFoundException(app_messages_1.APP_MESSAGES.NO_DATA_FOUND);
        }
        return information;
    }
